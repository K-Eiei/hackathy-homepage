  ...
  return (
    <Layout>
      <Container>
        ...
        <div className="text-3xl font-bold text-cta-text">Kongwarit Utapao</div>

        <Link
          to="/works"
          className="w-[200px] h-[40px] mt-4 px-7 bg-cta-btn hover:bg-teal-700 duration-200 flex justify-between items-center rounded-full text-lg font-semibold text-cta-btn-text"
          type="text"
